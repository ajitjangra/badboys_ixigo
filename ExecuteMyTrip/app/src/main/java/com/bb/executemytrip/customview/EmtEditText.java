...
public class EmtEditText extends EditText {
  public EmtEditText(final Context context) {
    super(context);
    if (!isInEditMode()) {
      init();
    }
  ...
  public EmtEditText(final Context context, final AttributeSet attrs) {
    super(context, attrs);
    if (!isInEditMode()) {
      init();
    }
  ...
  public EmtEditText(final Context context, final AttributeSet attrs, final int defStyleAttr) {
